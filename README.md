...
How it works
Add one decorator:
pythonfrom glasspipe import trace
...
Quickstart
pythonfrom glasspipe import trace, span
...
GlassPipeLangfuseLangSmithInstall time~60 seconds~20 minutes~20 minutesAccount requiredNeverYesYesShare a trace publiclyOne clickSeveral stepsSeveral stepsLocal dashboardYesNoNoTeam workspacesNoYesYesProduction monitoringNoYesYesAsync supportNoYesYesPriceFree, open sourceFree tier + paidFree tier + paid
...
bashpython examples/hello.py           # minimal — one span
